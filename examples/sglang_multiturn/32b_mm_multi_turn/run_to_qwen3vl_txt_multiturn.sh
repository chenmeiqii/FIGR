...
PROJ_NAME=mm_cot
EXP_NAME=qwen3vl-32b_txt_multiturn
SAVE_PATH=$PROJECT_DIR/checkpoints/${PROJ_NAME}/${EXP_NAME}
mkdir -p ${SAVE_PATH}

nohup python3 -m verl.trainer.main_ppo \
    --config-path="$CONFIG_PATH" \
    --config-name='mm_multiturn_txt_grpo' \
    ...
    data.train_files=$HOME/data/rl_data/train/train_tool_txt.parquet \
    actor_rollout_ref.rollout.multi_turn.tool_config_path="$CONFIG_PATH/tool_config/mm_tool_txt_config.yaml" \
